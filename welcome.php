...
<body>
    <p style=" font-size: xx-small; text-align: right;" id="nebitno" hidden>aa</p>
    ...
    <div class="container">
        <div class="alert alert alert-primary" role="alert">
            <h4 class="text-primary text-center">Find your own car and travel the world!</h4>
        </div>
    ...
    ?>
        ...
        <div class="dugmad">
            <a href="#" id="btnPreview" class="btn btn-success mr-3 profile" data-toggle="modal"
                data-target="#userViewModal" title="Prfile"><i class="fa fa-address-card-o" aria-hidden="true"></i></a>
